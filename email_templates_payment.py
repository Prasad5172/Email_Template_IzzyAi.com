...
def send_clinic_signup_link_email(recipient_email, sale_person_id, signup_link):
    try:
        ...
        # Email body with the sign-up link
        html_body = body_of_send_clinic_signup_link_email(sale_person_id,signup_link)
        msg.attach(MIMEText(html_body, 'html'))
...
def send_invoice_email(recipient_email, customer_name, invoice_id, total_amount, due_date):
    ...
    try:
        ...
        html_body = body_of_send_invoice_email(customer_name,invoice_id,total_amount,due_date)
        msg.attach(MIMEText(html_body, 'html'))
...
<body>
    <div class="container">
        ...
        <main>
            <div class="main-content">
                <p class="mb-5">Hi <span class="font-bold">{first_name}</span>,</p>
                <p class="mb-10">Congratulations—your <span class="font-bold">Monthly Unlimited subscription</span> has ocially started! We’re
                ...
                <p>You can upgrade to an <span class="font-bold">Annual IzzyAI Unlimited subscription</span> and enjoy greater savings
    ...
    <div class="container">
        ...
        <main>
            <div class="main-content">
                ...
                <p class="mb-10">We don’t want you to lose the progress you’ve already made <span class="font-bold">[Re-Subscribe Now]</span></p>
    ...
    <div class="container">
        ...
        <main>
            <div class="main-content">
                ...
                <p class="mb-10 font-bold">[Update My Payment Details]</p>
                <p class="mb-3">What Happens If It’s Not Fixed?</p>
    ...
    <div class="container">
        ...
        <main>
            <div class="main-content">
                ...
                <p class="mb-10 font-bold">[Upgrade to Unlimited]</p>
                <p class="mb-3">What Happens If It’s Not Fixed?</p>
